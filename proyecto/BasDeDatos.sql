...
SELECT Partidas.id FROM Jugadores, Partidas, Historal WHERE Jugadores.Username = 'Arnau' AND Partidas.Fecha = '15/02/2023' AND Jugadores.ID = Historial.idj AND Historial.idp = Partidas.id;
